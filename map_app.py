...
for lat, lon in raw_data:
    ...
    folium.Marker([lat, lon], popup=folium.Popup(p, max_width=200), icon=folium.DivIcon(html='<div style="font-size:20pt;">🥤</div>')).add_to(m)
...
head_html = f'''
    ...
    <meta name="apple-mobile-web-app-title" content="爆走ナビ">
    <link rel="apple-touch-icon" href="https://xinjiaantian83-prog.github.io/my-map/icon.png?v={int(time.time())}">
'''
